...
gulp.task('smile', gulp.series('clean:all', gulp.parallel(pages, styles, images, copy, svg, scripts)));
gulp.task('watcher', gulp.series('smile', gulp.parallel(watcher)));

/* ---- Main Tasks ---------------- */
gulp.task('cry', gulp.series('smile', gulp.parallel(watcher, server)));
